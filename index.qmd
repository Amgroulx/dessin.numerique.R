...
Voici un exemple de création de dégradé et d'attribution au hasard des couleurs dans une matrice. Des explorations approfondies permettront de créer des algorithmes de remplissage de la matrice plus intéressants.
