...
![Mise en carte pour un tissu de recouvrement, Cheney Brothers, 1913](data/CheneyBrothers_Carton.jpg)
...
![Mise en carte d'une image matricielle, archives personnelles](data/bref.png)
...
Voici 2 vidéos qui présentent des méthodes de génération algorithmique de fichiers prêts à tisser. Cette approche vise à exploiter le langage formel du pixel pour créer des tissages en utilisant seulement les fonctions automatiques et aléatoires de Photoshop sans avoir d'image de départ.
...
Exemples de graphiques classiques pouvant être générés avec R:
