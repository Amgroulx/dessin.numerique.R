...
Voici un exemple rapide de création de dégradé et d'attribution au hasard des couleurs dans une matrice. À chaque fois que la page esta ctualisée, la sélection de couleurs change.
...
### Création automatiques d'un dégradé de 100 couleurs:

```{r}
library(RColorBrewer)
coul <- colorRampPalette(palette)(100)
...
### Distribution aléatoire dans une matrice
```{r}
