...
Ce tissage à deux couches est basé sur la génération aléatoire d'un dégradé en diffusion. Il s'agit de la méthode qui a été utilisée pour réaliser la pièce WWW qu'on trouve dans le dossier visuel (matériel d'appui no. 15, 16, 17).
